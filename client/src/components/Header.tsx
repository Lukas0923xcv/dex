      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        ...
        <div className="flex items-center justify-between gap-2 sm:gap-4 mb-2.5 sm:mb-3">
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            {/* Pokéball Logo */}
            <div className="relative w-8 h-8 sm:w-9 sm:h-9 shrink-0 flex items-center justify-center drop-shadow-md">
              <svg
                viewBox="0 0 100 100"
            ...
            <div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className={`text-[10px] font-mono px-1.5 sm:px-2 py-0.5 rounded-full border ${
                  isBackendConnected
                  ...
                  <span className="sm:hidden">{isBackendConnected ? '● Online' : '○ Offline'}</span>
                  <span className="hidden sm:inline">{isBackendConnected ? '● SQLite Online' : '○ Offline Cache'}</span>
                </span>
              </div>
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <div className="relative" ref={accountMenuRef}>
              <button
                ...
                className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 sm:py-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-900/80 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200 font-bold text-xs transition-all shadow-xs cursor-pointer active:scale-95"
              ...
              >
                ...
                <span className="max-w-[65px] sm:max-w-[150px] truncate">{activeAccount.name}</span>
            ...
            <button
              ...
              className="flex items-center justify-center p-2 sm:px-3 sm:py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs transition-all shadow-md shadow-blue-500/20 cursor-pointer active:scale-95 shrink-0"
            ...
            {onOpenDashboardCustomizer && (
              <button
                ...
                className="flex items-center justify-center p-2 sm:px-3 sm:py-2 rounded-xl bg-purple-50 hover:bg-purple-100 border border-purple-200 text-purple-700 dark:bg-purple-950/60 dark:hover:bg-purple-900/60 dark:border-purple-800 dark:text-purple-300 font-bold text-xs transition-all shadow-xs cursor-pointer active:scale-95 shrink-0"
                title="Dashboard anpassen: Tabs anordnen und eigene Listen anheften"
              >
                <SlidersHorizontal className="w-4 h-4 sm:w-3.5 sm:h-3.5 text-purple-600 dark:text-purple-400" />
            ...
            <button
              ...
              className="p-2 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 dark:bg-slate-900/80 dark:hover:bg-slate-800 dark:border-slate-800 dark:text-slate-300 transition-colors shadow-xs cursor-pointer active:scale-95 shrink-0"
            ...
            <button
              ...
              className="p-2 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 dark:bg-slate-900/80 dark:hover:bg-slate-800 dark:border-slate-800 dark:text-slate-400 dark:hover:text-slate-200 transition-colors shadow-xs cursor-pointer active:scale-95 shrink-0"
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 overflow-x-auto pb-1.5 pt-0.5 no-scrollbar sm:scrollbar-thin touch-pan-x">
          {(() => {
              ...
              if (tab.type === 'custom') {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-xl text-xs sm:text-sm font-bold whitespace-nowrap transition-all cursor-pointer shrink-0 active:scale-95 ${
                      isActive
