...
export const Header: React.FC<HeaderProps> = ({
  ...
  const modes = [
    ...
    { id: 'form' as TrackingMode, label: 'Alle Formen', icon: Layers, color: 'text-indigo-400' },
    { id: 'costume' as TrackingMode, label: 'Kostüme', icon: Sparkles, color: 'text-pink-400' },
    { id: 'custom' as TrackingMode, label: 'Eigene Listen', icon: Bookmark, color: 'text-blue-400' },
  ];
